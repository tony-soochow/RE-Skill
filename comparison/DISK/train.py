...
class Workspace(object):
    ...
    def run(self):
        ...
        model_path = "/home/admin641/data_1T/qs/disk-main/Checkpoints/params.pth"
        self.agent.save_model(model_path)
        lower_level_agent = hydra.utils.instantiate(self.cfg.agent)
        lower_level_agent.load_model(model_path)
        # torch.save(self.agent.state_dict(), model_path)
        # lower_level_agent = hydra.utils.instantiate(self.cfg.agent)
        # lower_level_agent.load_state_dict(torch.load(model_path))
        print(lower_level_agent)
    ...
    #设置技能个数，number of skills = num_train_steps // steps_per_skill，同时设置每个技能步数为num_steps_per_skill
    # 总训练步数 除以 每个技能步数 即为技能个数
