...
class OptionGaussianActorCriticNet(nn.Module, BaseNet):
    ...
    def forward(self, obs):
        ...
        # flops_policy_1, params_policy_1 = profile(self.actor_body, inputs = (phi,))
        # flops_policy_2, params_policy_2 = profile(self.critic_body, inputs = (phi,))
        # flops_policy = flops_policy_1 + flops_policy_2
        # params_policy = params_policy_1 + params_policy_2

        # print("%s | %s | %s" % ("DAC Model", "FLOPs(G)", "Params(M)"))
        # print("------|-----------|------")
