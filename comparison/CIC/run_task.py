...
from cic_meta_env_wrapper import meta_env_wrapper
import torch
...
def run(frames=1000, eps_fixed=False, eps_frames=1e6, min_eps=0.01, eval_every=1000, eval_runs=20, worker=1):
    ...
    log_dir = "logs/" + args.env + "-" + time + ".txt"
    f = open(log_dir, "w")
...
if __name__ == "__main__":
    ...
    parser.add_argument("-env", type=str, default="Walker2dHurdle-v1", help="Name of meta env")
    ...
    lower_level_agent = torch.load("cic_checkpoints/"+args.env_name+"/agent_2000000.pt")
