...
register(
    id='HalfCheetah_hurdle-v4',
    entry_point='gym.envs.mujoco:HalfCheetahEnv_Hurdle_v4',
    max_episode_steps=1000,
    reward_threshold=4800.0,
)
register(
    id='HalfCheetah_hurdle_reverse-v2',
    entry_point='gym.envs.mujoco:HalfCheetahEnv_Hurdle_v2_reverse',
    max_episode_steps=1000,
    reward_threshold=4800.0,
)
register(
    id='Hopper_hurdle-v3',
    entry_point='gym.envs.mujoco:Hopper_hurdle_v3_Env',
    max_episode_steps=1000,
    reward_threshold=4800.0,
)
